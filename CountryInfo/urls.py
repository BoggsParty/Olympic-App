...
url(r'^womens-decathalon/$', views.womens_decathalon_detail, name='womens_decathalon_detail'),
url(r'^mens-decathalon/$', views.mens_decathalon_detail, name='mens_decathalon_detail'),
...
url(r'^mens-swimming-1500m-freestyle/$', views.mens_swimming_1500m_freestyle_detail, name='mens_swimming_1500m_freestyle_detail'),
