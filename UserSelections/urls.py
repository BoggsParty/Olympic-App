...
url(r'^womens-3000m-steeplechase/$', views.selection_womens_decathalon, name='selection_womens_decathalon'),
url(r'^mens-3000m-steeplechase/$', views.selection_mens_decathalon, name='selection_mens_decathalon'),
...
url(r'^mens-swimming-200m-IM/$', views.selection_mens_swimming_1500m_freestyle, name='selection_mens_swimming_1500m_freestyle'),
...
url(r'^show-jumping/$', views.selection_show_jumping, name='selection_show_jumping'),
]